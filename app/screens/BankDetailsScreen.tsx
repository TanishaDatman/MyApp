...
const BankDetailsSchema = z
  .object({
    ...
    sortCode: z.string().regex(/^\d{6}$/, "Sort code must be exactly 6 digits"),
    accountNumber: z
      .string()
      ...
      >
        <VStack className="space-y-2 mb-6">
          ...
          <Text className="text-sm sm:text-base text-textgrey mb-4">
            We need your bank details to ensure payouts are sent securely and on
            time. Providing this information helps avoid delays in receiving
            payments.
          </Text>
        </VStack>
